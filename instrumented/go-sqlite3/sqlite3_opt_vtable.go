...
func mPrintf(format, arg string) *C.char {
	prof.Conversion("27348574ff", "C.CString", int(len(format)+1))
	prof.Memory("27348574ff", "malloc", int(len(format)+1))
	__cgoprof_end_1 := prof.BeginCall("27348574ff", "CString")
	__cgoprof_ret_2 := C.CString(format)
	__cgoprof_end_1()
	cf := __cgoprof_ret_2
	defer func() {
		prof.Memory("27348574ff", "free", 0)
		__cgoprof_end_3 := prof.BeginCall("9d7c24555a", "free")
		C.free(unsafe.Pointer(cf))
		__cgoprof_end_3()
	}()
	prof.Conversion("3cd61b871e", "C.CString", int(len(arg)+1))
	prof.Memory("3cd61b871e", "malloc", int(len(arg)+1))
	__cgoprof_end_4 := prof.BeginCall("3cd61b871e", "CString")
	__cgoprof_ret_5 := C.CString(arg)
	__cgoprof_end_4()
	ca := __cgoprof_ret_5
	defer func() {
		prof.Memory("3cd61b871e", "free", 0)
		__cgoprof_end_6 := prof.BeginCall(

			"c4ca6815c5", "free")
		C.free(unsafe.Pointer(ca))
		__cgoprof_end_6()
	}()
	__cgoprof_end_7 := prof.BeginCall("eab007f89a", "_sqlite3_mprintf")
	__cgoprof_ret_8 := C._sqlite3_mprintf(cf, ca)
	__cgoprof_end_7()
	return __cgoprof_ret_8
}
...
func goMInit(db, pClientData unsafe.Pointer, argc C.int, argv **C.char, pzErr **C.char, isCreate C.int) C.uintptr_t {
	...
	defer func() {
		prof.Callback("5747bf4782", "C", time.Since(__cgoprof_callbackStart_9))
	}()
	...
	for i, s := range unsafe.Slice(argv, int(argc)) {
		prof.Conversion("8f653941ea", "C.GoString", int(0))
		__cgoprof_end_10 := prof.BeginCall("8f653941ea", "GoString")
		__cgoprof_ret_11 := C.GoString(s)
		__cgoprof_end_10()
		args[i] = __cgoprof_ret_11
	}
	var vTab VTab
	var err error
	if isCreate == 1 {
...
func goVRelease(pVTab unsafe.Pointer, isDestroy C.int) *C.char {
	__cgoprof_callbackStart_12 := time.Now()
	defer func() {
		prof.Callback("68840c2532", "C", time.Since(__cgoprof_callbackStart_12))
	}()
...
func goVOpen(pVTab unsafe.Pointer, pzErr **C.char) C.uintptr_t {
	__cgoprof_callbackStart_13 := time.Now()
	defer func() {
		prof.Callback("66bd506b00", "C", time.Since(__cgoprof_callbackStart_13))
	}()
	vt := lookupHandle(pVTab).(*sqliteVTab)
...
func goVBestIndex(pVTab unsafe.Pointer, icp unsafe.Pointer) *C.char {
	__cgoprof_callbackStart_14 := time.Now()
	defer func() {
		prof.Callback("2574e1d871", "C", time.Since(__cgoprof_callbackStart_14))
	}()
	vt := lookupHandle(pVTab).(*sqliteVTab)
	...
	__cgoprof_end_15 := prof.BeginCall("1c183c5fcc", "sqlite3_malloc")
	__cgoprof_ret_16 := C.sqlite3_malloc(C.int(len(res.IdxStr) + 1))
	__cgoprof_end_15()
	info.idxStr = (*C.char)(__cgoprof_ret_16)
	if info.idxStr == nil {
...
func goVClose(pCursor unsafe.Pointer) *C.char {
	__cgoprof_callbackStart_17 := time.Now()
	defer func() {
		prof.Callback("16e389a77f", "C", time.Since(__cgoprof_callbackStart_17))
	}()
...
func goMDestroy(pClientData unsafe.Pointer) {
	__cgoprof_callbackStart_18 := time.Now()
	defer func() {
		prof.Callback("f4da677f2d", "C",

			time.Since(__cgoprof_callbackStart_18))
	}()
	m := lookupHandle(pClientData).(*sqliteModule)
...
func goVFilter(pCursor unsafe.Pointer, idxNum C.int, idxName *C.char, argc C.int, argv **C.sqlite3_value) *C.char {
	__cgoprof_callbackStart_19 := time.Now()
	defer func() {
		prof.Callback("0d558d4eea", "C", time.Since(__cgoprof_callbackStart_19))
	}()
	vtc := lookupHandle(pCursor).(*sqliteVTabCursor)
	...
	prof.Conversion("6262641174", "C.GoString", int(0))
	__cgoprof_end_20 := prof.BeginCall("6262641174", "GoString")
	__cgoprof_ret_21 := C.GoString(idxName)
	__cgoprof_end_20()
	err := vtc.vTabCursor.Filter(int(idxNum), __cgoprof_ret_21, vals)
	if err != nil {
		return mPrintf("%s", err.Error())
	}
	return nil
...
func goVNext(pCursor unsafe.Pointer) *C.char {
	__cgoprof_callbackStart_22 := time.Now()
	defer func() {
		prof.Callback("e11bb8828b", "C", time.Since(__cgoprof_callbackStart_22))
	}()
	vtc := lookupHandle(pCursor).(*sqliteVTabCursor)
...
func goVEof(pCursor unsafe.Pointer) C.int {
	...
	defer func() {
		prof.Callback("b03d87b5b3", "C", time.Since(__cgoprof_callbackStart_23))
...
func goVColumn(pCursor, cp unsafe.Pointer, col C.int) *C.char {
	__cgoprof_callbackStart_24 := time.Now()
	defer func() {
		prof.Callback("c70fa2d7bb", "C", time.Since(__cgoprof_callbackStart_24))
	}()
	vtc := lookupHandle(pCursor).(*sqliteVTabCursor)
	c := (*SQLiteContext)(cp)
...
func goVRowid(pCursor unsafe.Pointer, pRowid *C.sqlite3_int64) *C.char {
	__cgoprof_callbackStart_25 := time.Now()
	defer func() {
		prof.Callback("ed40427ee2", "C", time.Since(__cgoprof_callbackStart_25))
	}()
	vtc := lookupHandle(pCursor).(*sqliteVTabCursor)
...
func goVUpdate(pVTab unsafe.Pointer, argc C.int, argv **C.sqlite3_value, pRowid *C.sqlite3_int64) *C.char {
	__cgoprof_callbackStart_26 := time.Now()
	defer func() {
		prof.Callback("58b59eeb7c", "C", time.Since(__cgoprof_callbackStart_26))
	}()
	vt := lookupHandle(pVTab).(*sqliteVTab)
...
func (c *SQLiteConn) DeclareVTab(sql string) error {
	prof.Conversion("aa3a61646d", "C.CString", int(len(sql)+1))
	prof.Memory("aa3a61646d", "malloc", int(len(sql)+1))
	__cgoprof_end_27 := prof.BeginCall("aa3a61646d", "CString")
	__cgoprof_ret_28 := C.CString(sql)
	__cgoprof_end_27()
	zSQL := __cgoprof_ret_28
	defer func() {
		prof.Memory("aa3a61646d", "free", 0)
		__cgoprof_end_29 := prof.BeginCall("d1c09ea67e", "free")
		C.free(unsafe.Pointer(zSQL))
		__cgoprof_end_29()
	}()
	__cgoprof_end_30 := prof.BeginCall("bf36403443", "sqlite3_declare_vtab")
	__cgoprof_ret_31 := C.sqlite3_declare_vtab(c.db, zSQL)
	__cgoprof_end_30()
	rv := __cgoprof_ret_31
	if rv != C.SQLITE_OK {
		return c.lastError()
...
func (c *SQLiteConn) CreateModule(moduleName string, module Module) error {
	prof.Conversion("d612b7c51d", "C.CString", int(len(moduleName)+1))
	prof.Memory("d612b7c51d", "malloc", int(len(moduleName)+1))
	__cgoprof_end_32 := prof.BeginCall("d612b7c51d", "CString")
	__cgoprof_ret_33 := C.CString(moduleName)
	__cgoprof_end_32()
	mname := __cgoprof_ret_33
	defer func() {
		prof.Memory("d612b7c51d", "free", 0)
		__cgoprof_end_34 := prof.BeginCall("68e8688b67", "free")
		C.free(unsafe.Pointer(mname))
		__cgoprof_end_34()
	}()
	udm := sqliteModule{c, moduleName, module}
	switch module.(type) {
	case EponymousOnlyModule:
		prof.PointerCheck("d1d11606bc", 50)
		__cgoprof_end_35 := prof.BeginCall("d1d11606bc", "_sqlite3_create_module_eponymous_only")
		__cgoprof_ret_36 := C._sqlite3_create_module_eponymous_only(c.db, mname, C.uintptr_t(uintptr(newHandle(c, &udm))))
		__cgoprof_end_35()
		rv := __cgoprof_ret_36
		if rv != C.SQLITE_OK {
			return c.lastError()
		...
		return nil
	case Module:
		prof.PointerCheck("b549595d77", 50)
		__cgoprof_end_37 := prof.BeginCall("b549595d77", "_sqlite3_create_module")
		__cgoprof_ret_38 := C._sqlite3_create_module(c.db, mname, C.uintptr_t(uintptr(newHandle(c, &udm))))
		__cgoprof_end_37()
		rv := __cgoprof_ret_38
		if rv != C.SQLITE_OK {
			return c.lastError()
