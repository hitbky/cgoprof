...
func Version() (libVersion string, libVersionNumber int, sourceID string) {
	__cgoprof_end_1 := prof.BeginCall("e82150d004", "sqlite3_libversion")
	__cgoprof_ret_2 := C.sqlite3_libversion()
	__cgoprof_end_1()
	prof.Conversion("f4d3e8216f", "C.GoString", int(0))
	__cgoprof_end_3 := prof.BeginCall("f4d3e8216f", "GoString")
	__cgoprof_ret_4 := C.GoString(__cgoprof_ret_2)
	__cgoprof_end_3()
	libVersion = __cgoprof_ret_4
	__cgoprof_end_5 := prof.BeginCall("d30aedf292", "sqlite3_libversion_number")
	__cgoprof_ret_6 := C.sqlite3_libversion_number()
	__cgoprof_end_5()
	libVersionNumber = int(__cgoprof_ret_6)
	__cgoprof_end_7 := prof.BeginCall("9eebc808a9", "sqlite3_sourceid")
	__cgoprof_ret_8 := C.sqlite3_sourceid()
	__cgoprof_end_7()
	prof.Conversion("59e3817652", "C.GoString", int(

		// used by authorizer and pre_update_hook
		0))
	__cgoprof_end_9 := prof.BeginCall("59e3817652", "GoString")
	__cgoprof_ret_10 := C.GoString(__cgoprof_ret_8)
	__cgoprof_end_9()
	sourceID = __cgoprof_ret_10
...
func (ai *aggInfo) agg(ctx *C.sqlite3_context) (int64, reflect.Value, error) {
	__cgoprof_end_11 := prof.BeginCall("6f45cd7d28", "sqlite3_aggregate_context")
	__cgoprof_ret_12 := C.sqlite3_aggregate_context(ctx, C.int(8))
	__cgoprof_end_11()
	aggIdx := (*int64)(__cgoprof_ret_12)
	if *aggIdx == 0 {
		*aggIdx = ai.next
...
func (c *SQLiteConn) RegisterCollation(name string, cmp func(string, string) int) error {
	...
	prof.Conversion("12a8775603", "C.CString", int(len(name)+1))
	prof.Memory("12a8775603", "malloc", int(len(name)+1))
	__cgoprof_end_13 := prof.BeginCall("12a8775603", "CString")
	__cgoprof_ret_14 := C.CString(name)
	__cgoprof_end_13()
	cname := __cgoprof_ret_14
	defer func() {
		prof.Memory("12a8775603", "free", 0)
		__cgoprof_end_15 := prof.BeginCall("69fe122172", "free")
		C.free(unsafe.Pointer(cname))
		__cgoprof_end_15()
	}()
	__cgoprof_end_16 := prof.BeginCall("43840c7d58", "sqlite3_create_collation")
	__cgoprof_ret_17 := C.sqlite3_create_collation(c.db, cname, C.SQLITE_UTF8, handle, (*[0]byte)(unsafe.Pointer(C.compareTrampoline)))
	__cgoprof_end_16()
	rv := __cgoprof_ret_17
	if rv != C.SQLITE_OK {
		return c.lastError()
...
func (c *SQLiteConn) RegisterCommitHook(callback func() int) {
	if callback == nil {
		__cgoprof_end_18 := prof.BeginCall("767a8e98a2", "sqlite3_commit_hook")
		C.sqlite3_commit_hook(c.db, nil, nil)
		__cgoprof_end_18()
	} else {
		__cgoprof_end_19 := prof.BeginCall("97a3395abb", "sqlite3_commit_hook")
...
func (c *SQLiteConn) RegisterRollbackHook(callback func()) {
	if callback == nil {
		__cgoprof_end_20 := prof.BeginCall("5ed52088b6", "sqlite3_rollback_hook")
		C.sqlite3_rollback_hook(c.db, nil, nil)
		__cgoprof_end_20()
	} else {
		__cgoprof_end_21 := prof.BeginCall("6132508de0", "sqlite3_rollback_hook")
...
func (c *SQLiteConn) RegisterUpdateHook(callback func(int, string, string, int64)) {
	if callback == nil {
		__cgoprof_end_22 := prof.BeginCall("bbbfceb8f1", "sqlite3_update_hook")
		C.sqlite3_update_hook(c.db, nil, nil)
		__cgoprof_end_22()
	} else {
		__cgoprof_end_23 := prof.BeginCall("a52fb4da53", "sqlite3_update_hook")
...
func (c *SQLiteConn) RegisterAuthorizer(callback func(int, string, string, string) int) {
	if callback == nil {
		__cgoprof_end_24 := prof.BeginCall("7a92df24fb", "sqlite3_set_authorizer")
		C.sqlite3_set_authorizer(c.db, nil, nil)
		__cgoprof_end_24()
	} else {
		__cgoprof_end_25 := prof.BeginCall("4ed5612d28", "sqlite3_set_authorizer")
...
func (c *SQLiteConn) RegisterFunc(name string, impl any, pure bool) error {
	...
	prof.Conversion("2367198b76", "C.CString", int(len(name)+1))
	prof.Memory("2367198b76", "malloc", int(len(name)+1))
	__cgoprof_end_26 := prof.BeginCall("2367198b76", "CString")
	__cgoprof_ret_27 := C.CString(name)
	__cgoprof_end_26()
	cname := __cgoprof_ret_27
	defer func() {
		prof.Memory("2367198b76", "free", 0)
		__cgoprof_end_28 := prof.BeginCall("f600541940", "free")
		C.free(unsafe.Pointer(cname))
		__cgoprof_end_28()
	}()
	opts := C.SQLITE_UTF8
...
func sqlite3CreateFunction(db *C.sqlite3, zFunctionName *C.char, nArg C.int, eTextRep C.int, pApp unsafe.Pointer, xFunc unsafe.Pointer, xStep unsafe.Pointer, xFinal unsafe.Pointer) C.int {
	__cgoprof_end_29 := prof.BeginCall("3d98770d67", "_sqlite3_create_function")
	__cgoprof_ret_30 := C._sqlite3_create_function(db, zFunctionName, nArg, eTextRep, C.uintptr_t(uintptr(pApp)), (*[0]byte)(xFunc), (*[0]byte)(xStep), (*[0]byte)(xFinal))
	__cgoprof_end_29(
...
func (c *SQLiteConn) RegisterAggregator(name string, impl any, pure bool) error {
	...
	prof.Conversion("d0bf12eb7a", "C.CString", int(len(name)+1))
	prof.Memory("d0bf12eb7a", "malloc", int(len(name)+1))
	__cgoprof_end_31 := prof.BeginCall("d0bf12eb7a", "CString")
	__cgoprof_ret_32 := C.CString(name)
	__cgoprof_end_31()
	cname := __cgoprof_ret_32
	defer func() {
		prof.Memory("d0bf12eb7a", "free", 0)
		__cgoprof_end_33 := prof.BeginCall("4f4ae1ecb9", "free")
		C.free(unsafe.Pointer(cname))
		__cgoprof_end_33()
	}()
	opts := C.SQLITE_UTF8
...
func (c *SQLiteConn) AutoCommit() bool {
	c.mu.Lock()
	defer c.mu.Unlock()
	__cgoprof_end_34 := prof.BeginCall("b4be34aac7", "sqlite3_get_autocommit")
	__cgoprof_ret_35 := C.sqlite3_get_autocommit(c.db)
	__cgoprof_end_34()
	return int(__cgoprof_ret_35) != 0
}
...
func lastError(db *C.sqlite3) error {
	__cgoprof_end_36 := prof.BeginCall(
		// returns SQLITE_NOMEM if db == nil
		"e888d117d9", "sqlite3_errcode")
	__cgoprof_ret_37 := C.sqlite3_errcode(db)
	__cgoprof_end_36()
	rv := __cgoprof_ret_37
	if rv == C.SQLITE_OK {
		return nil
	}
	__cgoprof_end_38 := prof.BeginCall("44b7254f54",
		// returns SQLITE_NOMEM if db == nil
		"sqlite3_extended_errcode")
	__cgoprof_ret_39 := C.sqlite3_extended_errcode(db)
	__cgoprof_end_38()
	extrv := __cgoprof_ret_39
	__cgoprof_end_40 := prof.BeginCall("f8acff463e", "sqlite3_errmsg")
	__cgoprof_ret_41 := C.sqlite3_errmsg(db)
	__cgoprof_end_40( // returns "out of memory" if db == nil
	)
	prof.Conversion("5f730d4034",
		...
		"C.GoString", int(0))
	__cgoprof_end_42 := prof.BeginCall("5f730d4034", "GoString")
	__cgoprof_ret_43 := C.GoString(__cgoprof_ret_41)
	__cgoprof_end_42()
	errStr := __cgoprof_ret_43

	var systemErrno syscall.Errno
	if rv == C.SQLITE_CANTOPEN || (rv == C.SQLITE_IOERR && extrv != C.SQLITE_IOERR_NOMEM) {
		__cgoprof_end_44 := prof.BeginCall("ce23c852a6", "sqlite3_system_errno")
		__cgoprof_ret_45 := C.sqlite3_system_errno(db)
		__cgoprof_end_44()
		systemErrno = syscall.Errno(__cgoprof_ret_45)
	}
...
func (c *SQLiteConn) execNoArgs(query string) (driver.Result, error) {
	...
	for len(query) > 0 {
		...
		var tail *C.char
		prof.Conversion("625f108886", "C.CString", int(len(query)+1))
		prof.Memory("625f108886", "malloc", int(len(query)+1))
		__cgoprof_end_46 := prof.BeginCall("625f108886", "CString")
		__cgoprof_ret_47 := C.CString(query)
		__cgoprof_end_46()
		pquery := __cgoprof_ret_47
		prof.PointerCheck("ed242be7f6", 50)
		__cgoprof_end_48 := prof.BeginCall("ed242be7f6", "_sqlite3_exec_no_args")
		__cgoprof_ret_49 := C._sqlite3_exec_no_args(c.db, pquery, C.int(len(query)), &rowid, &changes, &tail)
		__cgoprof_end_48()
		rv := __cgoprof_ret_49
		if tail != nil && *tail != '\000' {
			prof.Conversion("57fabcd2a1", "C.GoString", int(0))
			__cgoprof_end_50 := prof.BeginCall("57fabcd2a1", "GoString")
			__cgoprof_ret_51 := C.GoString(tail)
			__cgoprof_end_50()
			query = strings.TrimSpace(__cgoprof_ret_51)
		} else {
			query = ""
		}
		prof.Memory("625f108886", "free", 0)
		__cgoprof_end_52 := prof.BeginCall("6c3b16d491", "free")
...
func (d *SQLiteDriver) Open(dsn string) (driver.Conn, error) {
	__cgoprof_end_53 := prof.BeginCall("96c3c576e9", "sqlite3_threadsafe")
	__cgoprof_ret_54 := C.sqlite3_threadsafe()
	__cgoprof_end_53()
	if __cgoprof_ret_54 == 0 {
	...
	var db *C.sqlite3
	prof.Conversion("765d6f349a", "C.CString", int(len(dsn)+1))
	prof.Memory("765d6f349a", "malloc", int(len(dsn)+1))
	__cgoprof_end_55 := prof.BeginCall("765d6f349a", "CString")
	__cgoprof_ret_56 := C.CString(dsn)
	__cgoprof_end_55()
	name := __cgoprof_ret_56
	defer func() {
		prof.Memory("765d6f349a", "free", 0)
		__cgoprof_end_57 := prof.BeginCall("e4a7e0dd10", "free")
		C.free(unsafe.Pointer(name))
		__cgoprof_end_57()
	}()
	var vfs *C.char
	if vfsName != "" {
		prof.Conversion("fa367617cf", "C.CString", int(len(vfsName)+1))
		prof.Memory("fa367617cf", "malloc", int(len(vfsName)+1))
		__cgoprof_end_58 := prof.BeginCall("fa367617cf", "CString")
		__cgoprof_ret_59 := C.CString(vfsName)
		__cgoprof_end_58()
		vfs = __cgoprof_ret_59
		defer func() {
			prof.Memory("fa367617cf", "free", 0)
			__cgoprof_end_60 := prof.BeginCall("d0235b1ea9", "free")
			C.free(unsafe.Pointer(vfs))
			__cgoprof_end_60()
		}()
	}
	prof.PointerCheck("9931e9a822", 50)
	__cgoprof_end_61 := prof.BeginCall("9931e9a822", "_sqlite3_open_v2")
	__cgoprof_ret_62 := C._sqlite3_open_v2(name, &db,
	...
	if rv != 0 {
		...
		err := lastError(db)
		if db != nil {
			__cgoprof_end_63 := prof.BeginCall("e52eb13e42", "sqlite3_close_v2")
	...
	if err := exec(fmt.Sprintf("PRAGMA busy_timeout = %d;", busyTimeout)); err != nil {
		__cgoprof_end_64 := prof.BeginCall("91de20edb0", "sqlite3_close_v2")
		C.sqlite3_close_v2(db)
		__cgoprof_end_64()
		return nil, err
	}
	...
	if autoVacuum > -1 {
		if err := exec(fmt.Sprintf("PRAGMA auto_vacuum = %d;", autoVacuum)); err != nil {
			__cgoprof_end_65 := prof.BeginCall("e96703b8f9", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_65()
			return nil, err
		}
	...
	if caseSensitiveLike > -1 {
		if err := exec(fmt.Sprintf("PRAGMA case_sensitive_like = %d;", caseSensitiveLike)); err != nil {
			__cgoprof_end_66 := prof.BeginCall("d3ad9cda83", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_66()
			return nil, err
		}
	...
	if deferForeignKeys > -1 {
		if err := exec(fmt.Sprintf("PRAGMA defer_foreign_keys = %d;", deferForeignKeys)); err != nil {
			__cgoprof_end_67 := prof.BeginCall("e3b2006919", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_67()
			return nil, err
		}
	...
	if foreignKeys > -1 {
		if err := exec(fmt.Sprintf("PRAGMA foreign_keys = %d;", foreignKeys)); err != nil {
			__cgoprof_end_68 := prof.BeginCall("db1df2c990", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_68()
			return nil, err
		}
	...
	if ignoreCheckConstraints > -1 {
		if err := exec(fmt.Sprintf("PRAGMA ignore_check_constraints = %d;", ignoreCheckConstraints)); err != nil {
			__cgoprof_end_69 := prof.BeginCall("55f01100a8", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_69()
			return nil, err
		}
	...
	if journalMode != "" {
		if err := exec(fmt.Sprintf("PRAGMA journal_mode = %s;", journalMode)); err != nil {
			__cgoprof_end_70 := prof.BeginCall("c6a10b36eb", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_70()
			return nil, err
		}
	...
	if err := exec(fmt.Sprintf("PRAGMA locking_mode = %s;", lockingMode)); err != nil {
		__cgoprof_end_71 := prof.BeginCall("41a13b6cd7", "sqlite3_close_v2")
		C.sqlite3_close_v2(db)
		__cgoprof_end_71()
		return nil, err
	}
	...
	if queryOnly > -1 {
		if err := exec(fmt.Sprintf("PRAGMA query_only = %d;", queryOnly)); err != nil {
			__cgoprof_end_72 := prof.BeginCall("dabbe0b5b1", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_72()
			return nil, err
		}
	...
	if recursiveTriggers > -1 {
		if err := exec(fmt.Sprintf("PRAGMA recursive_triggers = %d;", recursiveTriggers)); err != nil {
			__cgoprof_end_73 := prof.BeginCall("531950d2a5", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_73()
			return nil, err
		}
	...
	if secureDelete != "DEFAULT" {
		if err := exec(fmt.Sprintf("PRAGMA secure_delete = %s;", secureDelete)); err != nil {
			__cgoprof_end_74 := prof.BeginCall("fb16c05b54", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_74()
			return nil, err
		}
	...
	if writableSchema > -1 {
		if err := exec(fmt.Sprintf("PRAGMA writable_schema = %d;", writableSchema)); err != nil {
			__cgoprof_end_75 := prof.BeginCall("70c8cb616f", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_75()
			return nil, err
		}
	...
	if cacheSize != nil {
		if err := exec(fmt.Sprintf("PRAGMA cache_size = %d;", *cacheSize)); err != nil {
			__cgoprof_end_76 := prof.BeginCall("922ce388fa", "sqlite3_close_v2")
			C.sqlite3_close_v2(db)
			__cgoprof_end_76()
			return nil, err
		}
...
func (c *SQLiteConn) Close() error {
	...
	__cgoprof_end_77 := prof.BeginCall("01e1c8dc50", "sqlite3_close_v2")
	__cgoprof_ret_78 := C.sqlite3_close_v2(c.db)
	__cgoprof_end_77()
	rv := __cgoprof_ret_78
	if rv != C.SQLITE_OK {
		return lastError(c.db)
...
func (c *SQLiteConn) putCachedStmt(s *SQLiteStmt) bool {
	...
	__cgoprof_end_79 := prof.BeginCall("9b26957d3b", "_sqlite3_reset_clear")
	__cgoprof_ret_80 := C._sqlite3_reset_clear(s.s)
	__cgoprof_end_79()
	rv := __cgoprof_ret_80
	if rv != C.SQLITE_ROW && rv != C.SQLITE_OK && rv != C.SQLITE_DONE {
		return false
...
func finalizeCachedStmt(s *SQLiteStmt) {
	...
	if s.s != nil {
		__cgoprof_end_81 := prof.BeginCall("e94ce7b3d5", "sqlite3_finalize")
...
func (c *SQLiteConn) prepare(ctx context.Context, query string) (driver.Stmt, error) {
	prof.Conversion("18a9fe4558", "C.CString", int(len(query)+1))
	prof.Memory("18a9fe4558", "malloc", int(len(query)+1))
	__cgoprof_end_82 := prof.BeginCall("18a9fe4558", "CString")
	__cgoprof_ret_83 := C.CString(query)
	__cgoprof_end_82()
	pquery := __cgoprof_ret_83
	defer func() {
		prof.Memory("18a9fe4558", "free", 0)
		__cgoprof_end_84 := prof.BeginCall("d59d77ce6f", "free")
		C.free(unsafe.Pointer(pquery))
		__cgoprof_end_84()
	}()
	var s *C.sqlite3_stmt
	var tail *C.char
	prof.PointerCheck("fd8e87bea7", 50)
	__cgoprof_end_85 := prof.BeginCall("fd8e87bea7", "_sqlite3_prepare_v2_internal")
	__cgoprof_ret_86 := C._sqlite3_prepare_v2_internal(c.db, pquery, C.int(len(query)), &s, &tail)
	__cgoprof_end_85()
	rv := __cgoprof_ret_86
	if rv != C.SQLITE_OK {
		return nil, c.lastError()
	...
	var t string
	if tail != nil && *tail != '\000' {
		prof.Conversion("48388421f8", "C.GoString", int(0))
		__cgoprof_end_87 := prof.BeginCall("48388421f8", "GoString")
		__cgoprof_ret_88 := C.GoString(tail)
		__cgoprof_end_87()
		t = strings.TrimSpace(__cgoprof_ret_88)
	}
...
func (c *SQLiteConn) GetFilename(schemaName string) string {
	...
	prof.Conversion("8fed3ae97c", "C.CString", int(len(schemaName)+1))
	prof.

		// GetLimit returns the current value of a run-time limit.
		// See: sqlite3_limit, http://www.sqlite.org/c3ref/limit.html
		Memory("8fed3ae97c", "malloc", int(len(schemaName)+1))
	__cgoprof_end_89 := prof.BeginCall("8fed3ae97c", "CString")
	__cgoprof_ret_90 := C.CString(schemaName)
	__cgoprof_end_89()
	__cgoprof_end_91 := prof.BeginCall("4b1e2bd6f3", "sqlite3_db_filename")
	__cgoprof_ret_92 := C.sqlite3_db_filename(c.db, __cgoprof_ret_90)
	__cgoprof_end_91()
	prof.Conversion("8f973740cd", "C.GoString", int(0))
	__cgoprof_end_93 := prof.BeginCall("8f973740cd", "GoString")
	__cgoprof_ret_94 := C.GoString(__cgoprof_ret_92)
	__cgoprof_end_93()
	return __cgoprof_ret_94
}

func (c *SQLiteConn) GetLimit(id int) int {
	__cgoprof_end_95 := prof.BeginCall("a748316330", "_sqlite3_limit")

	// SetLimit changes the value of a run-time limits.
	// Then this method returns the prior value of the limit.
	// See: sqlite3_limit, http://www.sqlite.org/c3ref/limit.html
	__cgoprof_ret_96 := C._sqlite3_limit(c.db, C.int(id), C.int(-1))
	__cgoprof_end_95()
	return int(__cgoprof_ret_96)
}

func (c *SQLiteConn) SetLimit(id int, newVal int) int {
	__cgoprof_end_97 := prof.BeginCall("04bfce04d0", "_sqlite3_limit")
	__cgoprof_ret_98 := C._sqlite3_limit(c.db, C.int(id), C.int(newVal))
	__cgoprof_end_97(
...
func (c *SQLiteConn) SetFileControlInt(dbName string, op int, arg int) error {
	...
	prof.Conversion("65b6910b1b", "C.CString", int(len(dbName)+1))
	prof.Memory("65b6910b1b", "malloc", int(len(dbName)+1))
	__cgoprof_end_99 := prof.BeginCall("65b6910b1b", "CString")
	__cgoprof_ret_100 := C.CString(dbName)
	__cgoprof_end_99()
	cDBName := __cgoprof_ret_100
	defer func() {
		prof.Memory("65b6910b1b", "free", 0)
		__cgoprof_end_101 := prof.BeginCall("be7f320512", "free")
		C.free(unsafe.Pointer(cDBName))
		__cgoprof_end_101()
	}()

	cArg := C.int(arg)
	prof.PointerCheck("a1b5fab348", 50)
	__cgoprof_end_102 := prof.BeginCall("a1b5fab348", "sqlite3_file_control")
	__cgoprof_ret_103 := C.sqlite3_file_control(c.db, cDBName, C.int(op), unsafe.Pointer(&cArg))
	__cgoprof_end_102()
	rv := __cgoprof_ret_103
	if rv != C.SQLITE_OK {
		return c.lastError()
	}
	return nil
...
func (c *SQLiteConn) SetFileControlInt64(dbName string, op int, arg int64) error {
	...
	prof.Conversion("f6c9b90812", "C.CString", int(len(dbName)+1))
	prof.Memory("f6c9b90812", "malloc", int(len(dbName)+1))
	__cgoprof_end_104 := prof.BeginCall("f6c9b90812", "CString")
	__cgoprof_ret_105 := C.CString(dbName)
	__cgoprof_end_104()
	cDBName := __cgoprof_ret_105
	defer func() {
		prof.Memory("f6c9b90812", "free", 0)
		__cgoprof_end_106 := prof.BeginCall("5874676662", "free")
		C.free(unsafe.Pointer(cDBName))
		__cgoprof_end_106()
	}()

	cArg := C.sqlite3_int64(arg)
	prof.PointerCheck("7129e96ead", 50)
	__cgoprof_end_107 := prof.BeginCall("7129e96ead", "sqlite3_file_control")
	__cgoprof_ret_108 := C.sqlite3_file_control(c.db, cDBName, C.int(op), unsafe.Pointer(&cArg))
	__cgoprof_end_107()
	rv := __cgoprof_ret_108
	if rv != C.SQLITE_OK {
		return c.lastError()
	}
	return nil
...
func (s *SQLiteStmt) Close() error {
	...
	s.s = nil
	s.c = nil
	__cgoprof_end_109 := prof.BeginCall("a588f9646e", "sqlite3_finalize")
	__cgoprof_ret_110 := C.sqlite3_finalize(stmt)
	__cgoprof_end_109()
	rv := __cgoprof_ret_110
	if rv != C.SQLITE_OK {
...
func (s *SQLiteStmt) NumInput() int {
	__cgoprof_end_111 := prof.BeginCall("8b3d601ccd", "sqlite3_bind_parameter_count")
	__cgoprof_ret_112 := C.sqlite3_bind_parameter_count(s.s)
	__cgoprof_end_111()
	return int(__cgoprof_ret_112)
}
...
func bindText(s *C.sqlite3_stmt, n C.int, v string) C.int {
	if len(v) == 0 {
		prof.PointerCheck("f59d12d5a2", 50)
		__cgoprof_end_113 := prof.BeginCall("f59d12d5a2", "_sqlite3_bind_text")
		__cgoprof_ret_114 := C._sqlite3_bind_text(s, n, (*C.char)(unsafe.Pointer(&placeHolder[0])), C.sqlite3_uint64(0))
		__cgoprof_end_113()
		return __cgoprof_ret_114
	}
	__cgoprof_end_115 := prof.BeginCall("0fff59e08a", "_sqlite3_bind_text")
	__cgoprof_ret_116 := C._sqlite3_bind_text(s, n, (*C.char)(unsafe.Pointer(unsafe.StringData(v))), C.sqlite3_uint64(len(v)))
	__cgoprof_end_115()
	return __cgoprof_ret_116
}

func bindValue(s *C.sqlite3_stmt, n C.int, value driver.Value) C.int {
	switch v := value.(type) {
	case nil:
		__cgoprof_end_117 := prof.BeginCall("d14811ede2", "sqlite3_bind_null")
		__cgoprof_ret_118 := C.sqlite3_bind_null(s, n)
		__cgoprof_end_117()
		return __cgoprof_ret_118
	case string:
		return bindText(s, n, v)
	case int64:
		__cgoprof_end_119 := prof.BeginCall("24af8d6f0b", "sqlite3_bind_int64")
		__cgoprof_ret_120 := C.sqlite3_bind_int64(s, n, C.sqlite3_int64(v))
		__cgoprof_end_119()
		return __cgoprof_ret_120
	case bool:
		if v {
			__cgoprof_end_121 := prof.BeginCall("bbb75a6394", "sqlite3_bind_int")
			__cgoprof_ret_122 := C.sqlite3_bind_int(s, n, 1)
			__cgoprof_end_121()
			return __cgoprof_ret_122
		}
		__cgoprof_end_123 := prof.BeginCall("c44e2d94ef", "sqlite3_bind_int")
		__cgoprof_ret_124 := C.sqlite3_bind_int(s, n, 0)
		__cgoprof_end_123()
		return __cgoprof_ret_124
	case float64:
		__cgoprof_end_125 := prof.BeginCall("7598ecfa83", "sqlite3_bind_double")
		__cgoprof_ret_126 := C.sqlite3_bind_double(s, n, C.double(v))
		__cgoprof_end_125()
		return __cgoprof_ret_126
	case []byte:
		if v == nil {
			__cgoprof_end_127 := prof.BeginCall("b095a879d5", "sqlite3_bind_null")
			__cgoprof_ret_128 := C.sqlite3_bind_null(s, n)
			__cgoprof_end_127()
			return __cgoprof_ret_128
		}
		ln := len(v)
		if ln == 0 {
			v = placeHolder
		}
		prof.PointerCheck("072afb9de7", 50)
		__cgoprof_end_129 := prof.BeginCall("072afb9de7", "_sqlite3_bind_blob")
		__cgoprof_ret_130 := C._sqlite3_bind_blob(s, n, unsafe.Pointer(&v[0]), C.sqlite3_uint64(ln))
		__cgoprof_end_129()
		return __cgoprof_ret_130
	case time.Time:
		var buf [64]byte
		b := v.AppendFormat(buf[:0], SQLiteTimestampFormats[0])
		if len(b) == 0 {
			prof.PointerCheck("f07d6b4bfe", 50)
			__cgoprof_end_131 := prof.BeginCall("f07d6b4bfe", "_sqlite3_bind_text")
			__cgoprof_ret_132 := C._sqlite3_bind_text(s, n, (*C.char)(unsafe.Pointer(&placeHolder[0])), C.sqlite3_uint64(0))
			__cgoprof_end_131()
			return __cgoprof_ret_132
		}
		prof.PointerCheck("305f1e47bd", 50)
		__cgoprof_end_133 := prof.BeginCall("305f1e47bd", "_sqlite3_bind_text")
		__cgoprof_ret_134 := C._sqlite3_bind_text(s, n, (*C.char)(unsafe.Pointer(&b[0])), C.sqlite3_uint64(len(b)))
		__cgoprof_end_133()
		return __cgoprof_ret_134
	default:
...
func (s *SQLiteStmt) bindNamedIndices(name string) [3]int {
	...
	for i, p := range prefixes {
		buf[0] = p
		__cgoprof_end_135 := prof.BeginCall("c3c2b2e1b0", "sqlite3_bind_parameter_index")
		__cgoprof_ret_136 := C.sqlite3_bind_parameter_index(s.s, cname)
		__cgoprof_end_135()
		indices[i] = int(__cgoprof_ret_136)
	}
...
func (s *SQLiteStmt) bind(args []driver.NamedValue) error {
	__cgoprof_end_137 := prof.BeginCall("212c04db36", "_sqlite3_reset_clear")
	__cgoprof_ret_138 := C._sqlite3_reset_clear(s.s)
	__cgoprof_end_137()
	rv := __cgoprof_ret_138
	if rv != C.SQLITE_ROW && rv != C.SQLITE_OK && rv != C.SQLITE_DONE {
...
func (s *SQLiteStmt) query(ctx context.Context, args []driver.NamedValue) (driver.Rows, error) {
	...
	if rows.nc > 0 {
		prof.Memory("da24077fea", "malloc", int(C.size_t(rows.nc)*C.size_t(unsafe.Sizeof(C.sqlite3_go_col{}))))
		prof.PointerCheck("da24077fea", 50)
		__cgoprof_end_139 := prof.BeginCall("da24077fea", "malloc")
		__cgoprof_ret_140 := C.malloc(C.size_t(rows.nc) * C.size_t(unsafe.Sizeof(C.sqlite3_go_col{})))
		__cgoprof_end_139()
		rows.colvals = (*C.sqlite3_go_col)(__cgoprof_ret_140)
		if rows.colvals == nil {
	...
	case <-ctx.Done():
		...
		default:
			__cgoprof_end_141 :=
				...
				prof.BeginCall("f6d288b9bf", "sqlite3_interrupt")

			C.sqlite3_interrupt(s.c.db)
			__cgoprof_end_141(
			// wait for goroutine completed
			)
			<-sema
...
func (s *SQLiteStmt) execSync(args []driver.NamedValue) (driver.Result, error) {
	if err := s.bind(args); err != nil {
		__cgoprof_end_142 := prof.BeginCall("274dd608a9", "_sqlite3_reset_clear")
	...
	var rowid, changes C.longlong
	prof.PointerCheck("3995321bec", 50)
	__cgoprof_end_143 := prof.BeginCall("3995321bec", "_sqlite3_step_row_internal")
	__cgoprof_ret_144 := C._sqlite3_step_row_internal(s.s, &rowid, &changes)
	__cgoprof_end_143()
	rv := __cgoprof_ret_144
	if rv != C.SQLITE_ROW && rv != C.SQLITE_OK && rv != C.SQLITE_DONE {
		err := s.c.lastError()
		__cgoprof_end_145 := prof.BeginCall("22312848ed", "_sqlite3_reset_clear")
		C._sqlite3_reset_clear(s.s)
		__cgoprof_end_145()
		return nil, err
	}
...
func (s *SQLiteStmt) Readonly() bool {
	__cgoprof_end_146 := prof.BeginCall("92a2c3fdfb",

		// Close the rows.
		"sqlite3_stmt_readonly")
	__cgoprof_ret_147 := C.sqlite3_stmt_readonly(s.s)
	__cgoprof_end_146()
	return __cgoprof_ret_147 == 1
}
...
func (rc *SQLiteRows) Close() error {
	...
	if s == nil {
		if rc.colvals != nil {
			prof.Memory("b2bf224a25", "free", 0)
			__cgoprof_end_148 := prof.BeginCall("b2bf224a25", "free")
	...
	if rc.colvals != nil {
		prof.Memory("778b508ad6", "free", 0)
		__cgoprof_end_149 := prof.BeginCall("778b508ad6", "free")
		C.free(unsafe.Pointer(rc.colvals))
		__cgoprof_end_149()
		rc.colvals = nil
	}
	...
	__cgoprof_end_150 := prof.BeginCall("aa2388e85a", "sqlite3_reset")
	__cgoprof_ret_151 := C.sqlite3_reset(s.s)
	__cgoprof_end_150()
	rv := __cgoprof_ret_151
	if rv != C.SQLITE_OK {
		s.mu.Unlock()
		return s.c.lastError()
	}
...
func (rc *SQLiteRows) Columns() []string {
	...
	if rc.s.s != nil && int(rc.nc) != len(rc.cols) {
		...
		for i := range rc.cols {
			__cgoprof_end_152 := prof.BeginCall("25cc82ac3b", "sqlite3_column_name")
			__cgoprof_ret_153 := C.sqlite3_column_name(rc.s.s, C.int(i))
			__cgoprof_end_152()
			prof.Conversion("1fb70eb066", "C.GoString", int(0))
			__cgoprof_end_154 := prof.BeginCall("1fb70eb066", "GoString")
			__cgoprof_ret_155 := C.GoString(__cgoprof_ret_153)
			__cgoprof_end_154()
			rc.cols[i] = __cgoprof_ret_155
		}
	}
	return rc.cols
}
...
func (rc *SQLiteRows) declTypes() []string {
	if rc.s.s != nil && rc.decltype == nil {
		...
		for i := range rc.decltype {
			__cgoprof_end_156 := prof.BeginCall("7c53d39812", "sqlite3_column_decltype")
			__cgoprof_ret_157 := C.sqlite3_column_decltype(rc.s.s, C.int(i))
			__cgoprof_end_156()
			prof.Conversion(

				// DeclTypes return column types.
				"3db7b9fed5", "C.GoString", int(0))
			__cgoprof_end_158 := prof.BeginCall("3db7b9fed5", "GoString")
			__cgoprof_ret_159 := C.GoString(__cgoprof_ret_157)
			__cgoprof_end_158()
			rc.decltype[i] = strings.ToLower(__cgoprof_ret_159)
		}
	}
	return rc.decltype
}
	...
	case <-rc.ctx.Done():
		...
		default:
			__cgoprof_end_160 :=
				...
				prof.BeginCall("d828f83e98", "sqlite3_interrupt")
...
func (rc *SQLiteRows) nextSyncLocked(dest []driver.Value) error {
	__cgoprof_end_161 := prof.BeginCall("7f9abaef1c", "_sqlite3_step_internal")
	__cgoprof_ret_162 := C._sqlite3_step_internal(rc.s.s)
	__cgoprof_end_161()
	rv := __cgoprof_ret_162
	if rv == C.SQLITE_DONE {
		return io.EOF
	}
	if rv != C.SQLITE_ROW {
		__cgoprof_end_163 := prof.BeginCall("4e0a35db7a", "sqlite3_reset")
		__cgoprof_ret_164 := C.sqlite3_reset(rc.s.s)
		__cgoprof_end_163()
		rv = __cgoprof_ret_164
		if rv != C.SQLITE_OK {
	...
	__cgoprof_end_165 := prof.BeginCall("b0d22a4c6f", "_sqlite3_column_values")
	...
	for i := range dest {
		...
		case C.SQLITE_BLOB:
			...
			n := col.n
			prof.Conversion("000169ff41", "C.GoBytes", int(n))
			__cgoprof_end_166 := prof.BeginCall("000169ff41", "GoBytes")
			__cgoprof_ret_167 := C.GoBytes(p, n)
			__cgoprof_end_166()
			dest[i] = __cgoprof_ret_167
		case C.SQLITE_NULL:
			dest[i] = nil
		case C.SQLITE_TEXT:
			var err error
			...
			n := int(col.n)
			prof.Conversion("1425daf1e7", "C.GoStringN", int(C.int(n)))
			prof.PointerCheck("1425daf1e7", 50)
			__cgoprof_end_168 := prof.BeginCall("1425daf1e7", "GoStringN")
			__cgoprof_ret_169 := C.GoStringN((*C.char)(unsafe.Pointer(col.ptr)), C.int(n))
			__cgoprof_end_168()
			s := __cgoprof_ret_169
